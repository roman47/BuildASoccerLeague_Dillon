...
if __name__ == "__main__":
    ...
    def process_players(player_data):
        ...
        # Create a text file named teams.txt that includes the name of a team, followed by the players
        # on that team. List all three teams and their players.
    def print_teams(sorted_player_data):
        ...
        for team in TEAM_NAMES:
            ...
            # and the player's guardian names.
            # Separate each bit of player information by a comma. For example,
            # the text file might start something like this:
            for player in sorted_player_data:
                if player["Team Name"] == team:
                    teams_file.write(player["Name"] + ", "
    ...
    def print_welcome_letters(sorted_player_data):
        ...
        For example, kenneth_love.txt. Make sure that each file begins with the text "Dear" followed by the guardian(s)
        name(s). Also include
        ...
        for player in sorted_player_data:
            ...
            welcome_letter_file.write("Dear {},\n"
                                      "You child, {}, is a new member of the team {}. "
                                      "The first practice will be on {}.\n"
